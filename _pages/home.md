...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/oceanix.jpg" style="height: 400px" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/fig_SSHDinAE.jpg" style="height: 400px" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/fig_detideNet.jpg" style="height: 400px" alt="Slide 3" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/fig_4DVarNN_SSH.jpg" style="height: 400px" alt="Slide 4" />
        </div>
        <!--<div class="item">
...
<figure class="fourth">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/logo_OceanixSupport.jpg" style="width: 1000px">
